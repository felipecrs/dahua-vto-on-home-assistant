import{dl as e,ci as t,y as s,dq as a,dr as r,ds as i,dt as o,bE as h,du as l,bF as n,bI as u,s as c,cr as d,cy as y,l as p,cw as m,bG as _}from"./card-3c450f9e.js";import{i as v,c as f}from"./ha-hls-player-c1401049.js";import{m as g}from"./audio-557099cb.js";import{s as $,h as b,M as w}from"./title-control-762f9db4.js";import{g as R}from"./live-0c4280a6.js";import"./media-layout-8e0c974f.js";customElements.whenDefined("ha-web-rtc-player").then((()=>{let c=class extends(customElements.get("ha-web-rtc-player")){async play(){return this._video?.play()}async pause(){this._video?.pause()}async mute(){this._video&&(this._video.muted=!0)}async unmute(){this._video&&(this._video.muted=!1)}isMuted(){return this._video?.muted??!0}async seek(e){this._video&&(this._video.currentTime=e)}async setControls(e){this._video&&$(this._video,e??this.controls)}isPaused(){return this._video?.paused??!0}async getScreenshotURL(){return this._video?e(this._video):null}render(){return this._error?t(this,`${this._error} (${this.entityid})`):s`
        <video
          ...
          @loadeddata=${e=>{a(this,e,{player:this,capabilities:{supportsPause:!0,hasAudio:g(this._video)}})}}
          @volumechange=${()=>r(this)}
          @play=${()=>i(this)}
          @pause=${()=>o(this)}
        ></video>
      `}static get styles(){return[super.styles,h(f),l`
          :host {
            width: 100%;
            height: 100%;
          }
        ...
        ></frigate-card-ha-web-rtc-player>`:void 0:s``;var e}static get styles(){return[super.styles,h(f),l`
          :host {
            width: 100%;
            height: 100%;
          }
